        ...
        {salaries.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-gray-400">
              Hãy kiểm tra bộ lọc hoặc liên hệ quản lý nếu cần
            </p>
          </div>
        ) : (*/}
      <div className="card">
        ...
        <div className="flex">
          ...
          <div className="ml-3">
            <p className="text-sm text-blue-800">
              Bảng lương được tính dựa trên lương cơ bản, ngày công, thưởng/phạt
              và khấu trừ bảo hiểm (10.5%). Nếu có thắc mắc, vui lòng liên hệ
              quản lý phòng ban.
            </p>
          </div>
        </div>
